    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black pt-20 pb-10">
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto flex flex-col items-center">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            Experience the next generation of communication with VaibTalk. Chat,
            video call, and share files with a futuristic interface designed for
            the modern web.
          </motion.p>
          ...
          >
            <Link href="/chat" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto h-12 px-8 text-base bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 border-0 shadow-lg shadow-purple-500/25 transition-all duration-300 hover:scale-105"
              >
                Start Chatting
            ...
            <Link href="/call" className="w-full sm:w-auto">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto h-12 px-8 text-base border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-105"
              >
                Try Video Call
              </Button>
            </Link>
            ...
            <div className="aspect-video w-full bg-black/40 relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center px-4">
                  <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 flex items-center justify-center shadow-lg shadow-purple-500/20">
                    <img
                      src="/logo.svg"
                      alt="VaibTalk Logo"
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-[10px] md:text-xs text-cyan-400">
                    85%
                  </div>
                </div>
